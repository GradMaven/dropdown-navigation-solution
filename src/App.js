    ...
    <>
      <header className="p-5 flex items-center justify-between">
        <div className="lg:flex lg:items-start lg:justify-start">
          <img src={logo} alt="" className="lg:mr-4" />
        ...
        <div className="hidden lg:block">
          <button className="mr-8 opacity-75">Login</button>
          <button
            className="border-2 border-black opacity-75
      ...
      >
        <article className="text-center md:text-left px-5 xl:px-0">
          ...
          <button
            className="bg-black rounded-lg shadow text-white
            font-bold hover:opacity-75 transition-all duration-150 pt-3 
            pb-2 px-6 cursor-pointer"
          >
            Learn more
          </button>

          <ul
            className="grid grid-cols-4 gap-1 mt-10 place-items-center 
              md:place-items-start"
          >
            <li>
              <img src={databiz} alt="" className="w-16 md:w-22" />
            </li>
            <li>
              <img src={audiophile} alt="" className="w-16 md:w-22" />
            </li>
            <li>
              <img src={maker} alt="" className="w-16 md:w-22" />
            </li>
            <li>
              <img src={meet} alt="" className="w-16 md:w-22" />
            </li>
          </ul>
        </article>
      ...
      <div className="attribution">
        ...
        . Coded by <a href="#">Leonard Ondigo</a>.
      </div>
    </>
  );
}
